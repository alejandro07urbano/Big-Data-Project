...
if not is_venv_installed():
    ...
    def big_data_python_demo():
        ...
        def clean(order_data_dict: dict):
            ...
            url = 'https://www.cdc.gov/flu/weekly/index.htm'
            url = 'https://www.usnews.com/news/health-news/articles/weekly-flu-cases-deaths-hospitalizations'
            htm1_content = getch.data(url)
            parsed_data = parsed_data(htm1_content)
            cleaned_data = cleaned_data(parsed_data)
        ...
        @task()
        def analysis(total_order_value: float):
            """
            #### Load task
        ...
        analysis(order_summary["total_order_value"])
